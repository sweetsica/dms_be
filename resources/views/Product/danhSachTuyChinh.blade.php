...
@php
    ...
    $listData = [['id' => 1, 'code' => 'TC0001', 'name' => 'Động cơ', 'usermanager' => 'Nguyễn Văn A - TBHT00', 'email' => 'Phiên bản xe GoCute 4 bánh', 'nhom' => '2', 'kenh' => 'OTC'], ['id' => 2, 'code' => 'TC0002', 'name' => 'Nội thất', 'usermanager' => 'Nguyễn Văn B - MTDH01', 'email' => 'Phiên bản xe GoCute 6 bánh', 'nhom' => '3', 'kenh' => 'ETC']];
...
@section('content')
                            ...
                            <div class='row'>
                                <div class="col-md-12">
                                    <div class="action_wrapper d-flex justify-content-end mb-3">
                                        ...
                                        <div class="action_export ms-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                            aria-label="Thêm tuỳ chỉnh" data-bs-original-title="Thêm tuỳ chỉnh">
                                            <button class="btn btn-danger d-block testCreateUser" data-bs-toggle="modal"
                                                data-bs-target="#add">Thêm tuỳ chỉnh</button>
                                        </div>
                                    </div>
                                        ...
                                        <table id="dsDaoTao"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="text-nowrap text-center" style="width:30%">Thuộc phiên bản
                                                    </th>
                                            ...
                                            <tbody>
                                                @foreach ($listCustom as $item)
                                                    <tr class="table-row" role="button">

                                                        <td>
                                                            <div class="overText text-center">
                                                                {{ $listCustom->total() - $loop->index - ($listCustom->currentPage() - 1) * $listCustom->perPage() }}
                                                            </div>
                                                        </td>
                                                        <td>
    ...
    @foreach ($listCustom as $item)
        {{-- delete --}}
        <div class="modal fade" id="xoaTuyChinh{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('custom.destroy', ['id' => $item->id]) }}" method="POST">
                            @csrf
                            @method('DELETE')
        ...
        {{-- edit --}}
        <div class="modal fade" id="suaTuyChinh{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header text-center">
                    ...
                    <form id="formThemCapPhat" method="POST"
                        action="{{ route('custom.update', ['id' => $item->id]) }}">
                        @csrf
                        @method('PUT')
                        <div class="modal-body">
                            <div class="row">
    ...
    <div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="formThemCapPhat" method="POST" action="{{ route('custom.store') }}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3" data-bs-toggle="tooltip" data-bs-placement="top"
                                ...
                                <select class="selectpicker" required data-dropup-auto="false" data-width="100%"
                                    ...
                                    name="version_ids[]" data-live-search-placeholder="Tìm kiếm..." multiple>
                                    @foreach ($listVersion as $ver)
