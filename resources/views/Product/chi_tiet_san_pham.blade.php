            ...
            <div class="main">
                <div class="container-fluid">
                    <div class="mainSection_heading">
                        <h5 class="mainSection_heading-title">Chi tiết sản phẩm</h5>
                            ...
                            <div class="warrper-header mb-5">
                                <div
                                    ...
                                    <div class="title-hearder text-center">
                                        <div class="fw-bold text-title_header mb-4">THÔNG SỐ SẢN PHẨM</div>
                            ...
                            <div class="col-7 text-center">
                                <div class="container">
                                    <div class="row g-4">
                                        ...
                                        <div class="col-12">
                                            <div
                                                style="display: grid; grid-template-columns: auto auto auto auto; gap: 15px">
                                                <img src="{{ $product->thumbnail }}" class="img-slider_nav"
                                                    style="padding: 0" alt="Slider Nav" />
                                                @if (!empty(json_decode($details->images)))
                                                    @php
                                                        $imageCount = 0;
                                                    @endphp
