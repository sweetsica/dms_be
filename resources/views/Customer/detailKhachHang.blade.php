                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="col-4 mt-3">
                                                ...
                                                <a
                                                    href="{{ route('customer.download', ['id' => $customer->id, 'name' => $file]) }}">{{
                                                    $file }}</a>
                                                <br>
                                                @endif
                                                @endforeach
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-lg-5">
                                                            <div class="layout_120">
                                                                ...
                                                                <span class="fs-4"> {{ $customer->companyName ?? ''
                                                                    }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3">
                                                            <div class="layout_120">
                                                                ...
                                                                <span class="fs-4">{{ $customer->companyPhoneNumber
                                                                    ??
                                                                    '' }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4">
                                                            <div class="row g-0">
                                                                ...
                                                                <div class="col-lg-7 text-end">
                                                                    <span class="fs-4">{{ $customer->companyEmail ??
                                                                        ''
                                                                        }}</span>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-lg-5 mt-4">
                                                            <div class="layout_120">
                                                                ...
                                                                <span class="fs-4">{{ $customer->taxCode ?? ''
                                                                    }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-3 mt-4">
                                                            <div class="layout_120">
                                                                ...
                                                                <span class="fs-4">{{ $customer->personCompany ?? ''
                                                                    }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-4 mt-4">
                                                            <div class="row g-0">
                                                                ...
                                                                <div class="col-lg-7 text-end">
                                                                    <span class="fs-4">{{ $customer->career ?? ''
                                                                        }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="row mt-3">
                                                        <div class="col-lg-5 mt-4">
                                                            <div class="layout_120">
                                                                ...
                                                                <span class="fs-4">{{ $customer->accountNumber ?? ''
                                                                    }}</span>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-7 mt-4">
                                                            <div class="layout_120">
                                                                ...
                                                                <span class="fs-4">{{ $customer->bankOpen ?? ''
                                                                    }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-12 mt-4">
                                                                    <div class="layout_120">
                                                                        ...
                                                                        <span class="fs-4">{{ $customer->district ??
                                                                            ''
                                                                            }}</span>
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-12 mt-4">
                                                                    <div class="layout_120">
                                                                        ...
                                                                        <span class="fs-4">{{ $customer->guide ?? ''
                                                                            }}</span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 mt-4">
                                                                <div class="layout_120">
                                                                    ...
                                                                    <span class="fs-4">{{ $customer->channel->name
                                                                        ?? ''
                                                                        }}</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12 mt-4">
                                                                <div class="layout_120">
                                                                    ...
                                                                    <span class="fs-4">{{ $customer->route->name ??
                                                                        ''
                                                                        }} -
