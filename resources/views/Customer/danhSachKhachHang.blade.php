            ...
            <form id="formThemCapPhat" method="POST" action="{{ route('create-customer') }}">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3" data-bs-toggle="tooltip" data-bs-placement="top" title="Tỉnh/thành">
                            <select class="form-select" required data-dropup-auto="false" data-width="100%"
                                data-live-search="true" title="Tỉnh/thành*" data-select-all-text="Chọn tất cả"
...
<script>
    ...
    var renderData = (array, select) => {
        ...
        document.querySelector("#district").innerHTML = '<option disable value="">Chọn Quận/Huyện</option>';
        document.querySelector("#guide").innerHTML = '<option disable value="">Chọn Phường/Xã</option>';
