                                                    ...
                                                    <table id="dsDaoTao"
                                                        ...
                                                        <thead>
                                                            <tr>
                                                                ...
                                                                <th class="text-nowrap text-center">Mã nhân sự</th>
                                                                <th class="text-nowrap text-center">Tên nhân sự</th>
                                                                <th class="text-nowrap text-center">Đơn vị công tác (phòng
                                                                    ban)</th>
                                                                <th class="text-nowrap text-center">Vị trí/ chức danh</th>
                                                                <th class="text-nowrap text-center">Cấp nhân sự</th>
                                                                <th class="text-nowrap text-center">Vai trò</th>
                                                                <th class="text-nowrap text-center">Địa bàn</th>
                                                                <th class="text-nowrap text-center">Email</th>
                                                                <th class="text-nowrap text-center">Số điện thoại</th>
                                                                <th class="text-nowrap text-center">Hình thức</th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class=" text-center">
                                                                        {{-- {{ $a++ }} --}}
                                                                        {{ $personnelList->total() - $loop->index - ($personnelList->currentPage() - 1) * $personnelList->perPage() }}
                                                                    </td>
                                                                    <td class="">
