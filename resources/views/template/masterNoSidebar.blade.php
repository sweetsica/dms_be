        ...
        <header id="header" class="header fixed-top" data-scrollto-offset="0">
            <div class="container-fluid d-flex align-items-center justify-content-between">
                ...
                <div class="header_actions-wrapper d-flex align-items-center dropdown">
                    ...
                    <div class="header_user dropdown" style="margin-right: 0%">
                            ...
                            <div class="col-sm-9 mb-3">
                                <div data-bs-toggle="tooltip" data-bs-placement="top" title="Đơn vị">
                                    <select class="selectpicker" data-dropup-auto="false" title="Chọn đơn vị"
                                        ...
                                        @foreach (session('listDepartments') as $dep)
                                            @if (session('user')['departement_id'] == $dep->id)
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body p-2">
                    <div class="row">
                        @foreach (Session::get('versions') as $version)
                            <div class="col-12 mb-3">
                                <div class="changeLog">
                                    <div class="changeLog-title mb-3">
                                        <div class="d-flex align-items-center pb-1">
                                            <div class="d-inline-block fs-5 text-uppercase fw-bold me-3">Version
                                                {{ $version['nameVersion'] }}</div>
                                            {!! $version['status'] > 0
                                                ? '<div class="background_green pt-1 pb-1 pe-2 ps-2 d-inline-block fs-5">Phiên bản mới</div>'
                                                : '' !!}
                                        </div>
                                        <div class="fw-normal fs-6 text-black" id="exampleModalLabel">
                                            Cập nhật
                                            {{ \Carbon\Carbon::parse($version['created_at'])->format('d/m/Y') }}
                                        </div>
                                    </div>
                                    <div class="chageLog-list fs-5">
                                        {{-- <li class="changeLog-items"> --}}
                                        {!! nl2br(e($version['noteVersion'])) !!}
                                        {{-- </li> --}}
                                    </div>
                                </div>
                            </div>
