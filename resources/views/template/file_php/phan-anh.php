                                        ...
                                        <div class="col-md-6">
                                            <div class="form-control">
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-6 mb-3 ">
                                                        <select class="selectpicker" data-dropup-auto="false" data-width="100%" title="Chọn phòng/ban">
                                            ...
                                            <div class="form-control">
                                                <div class="row mb-3 mt-3">
                                                    <div class="col-md-6 d-flex">
                                                        ...
                                                        <select class="selectpicker" data-dropup-auto="false" multiple data-actions-box="true"
