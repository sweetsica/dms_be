                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td class=" text-center">
                                                                        {{-- {{ $i++ }} --}}
                                                                        {{ $SpecificationsList->total() - $loop->index - ($SpecificationsList->currentPage() - 1) * $SpecificationsList->perPage() }}
                                                                    </td>
                                                                    <td>
    ...
    <div class="modal fade" id="taoDeXuat" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="addForm" action="{{ route('Specifications.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-6 mb-3">
